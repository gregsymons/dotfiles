...
if exists('b:loaded_ftplug___c_stl_vim') | finish | endif
let b:loaded_ftplug___c_stl_vim = 1
"
let s:cpo_save=&cpo
set cpo&vim
"
...
"=============================================================================
" Global Definitions: {{{
if exists("g:loaded___c_stl_vim") 
  let &cpo=s:cpo_save
  finish 
endif
let g:loaded___c_stl_vim = 1
"------------------------------------------------------------------------
